...
(def initial-impossibilities-check (impos-chain keyword? initial-impossibilities-chain))
(s/defn old-initial-impossibilities-check :- (s/maybe InitiallyCheckedImpossibility)
